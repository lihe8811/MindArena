...
export async function register(payload: { name: string; email: string; password: string }) {
  return request<VerificationChallenge>('/api/session/register', {
    method: 'POST',
...
export async function login(email: string, password: string) {
  return request<VerificationChallenge>('/api/session/login', {
    method: 'POST',
...
export function resendLoginVerification(email: string) {
  return request<VerificationChallenge>('/api/session/resend-login-code', {
    method: 'POST',
...
export function verifyEmail(payload: { email: string; code: string }) {
  return request<EmailVerificationResponse>('/api/session/verify-email', {
    method: 'POST',
    body: JSON.stringify(payload),
  });
}
...
export function resendVerification(email: string) {
  return request<VerificationChallenge>('/api/session/resend-verification', {
    method: 'POST',
    body: JSON.stringify({ email }),
  });
}
